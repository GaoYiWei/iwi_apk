<template>
    <div>
        ...
        <vxe-form :class="{ 'readonly': ctrlDisabled.table }" :data="formData" :rules="formRules" ref="picklistForm">
...
export default {
    ...
    methods : {
        ...
        saveEvent() {
            this.searchVal = null
            this.$refs['picklistForm'].validate((valid) => {
                if(!valid) {
